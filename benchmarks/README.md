...
| `admission-control/` | Does a *sustained* flood shed, or only a cold one — and is the growth in latency inside admission control or upstream of it? **Written and run 2026-09-09**, with the k6 generator [Q-140](../docs/open-questions.md) chose. It is the only load generator in this repository that is committed rather than retyped | ADR-046 condition 1, Q-140, [D-145](../docs/architecture-debt.md), [D-249](../docs/architecture-debt.md) |
