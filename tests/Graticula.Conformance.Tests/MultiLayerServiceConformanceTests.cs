...
/// one.</b> Set <c>GRATICULA_TEST_MULTILAYER</c> to its address (for example
...
public sealed class MultiLayerServiceConformanceTests : ArcGisClient
{
    ...
    public const string ServiceVariable = "GRATICULA_TEST_MULTILAYER";
    ...
    /// </summary>
    public const string GroupedVariable = "GRATICULA_TEST_GROUPED";
