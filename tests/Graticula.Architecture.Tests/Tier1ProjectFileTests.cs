...
public sealed class Tier1ProjectFileTests
{
    ...
    [
        Path.Combine("src", "Graticula.Core", "Graticula.Core.csproj"),
        Path.Combine("src", "Graticula.Platform", "Graticula.Platform.csproj"),
        Path.Combine("src", "Graticula.Api.ArcGis", "Graticula.Api.ArcGis.csproj"),
    ];
    ...
    private static DirectoryInfo FindRepositoryRoot()
    {
        ...
        while (directory is not null && !File.Exists(Path.Combine(directory.FullName, "graticula.sln")))
        {
