...
/// WKB in base64, which <see cref="Graticula.Geometries.WkbReader"/> and
/// <see cref="Graticula.Geometries.WkbWriter"/> already produce and consume, so
...
internal static class Program
{
    ...
    private static OverlayResponse Compute(OverlayRequest request)
    {
        ...
        // and Graticula.Geometries deliberately does not model one
