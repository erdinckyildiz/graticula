...
| **ArcGIS GeometryServer** | Owner: crucial. A thin surface over PROJ and NetTopologySuite — with the caps A11 demands, see §6. **2026-08-14: the overlay half is blocked on [Q-97](open-questions.md).** A-042 said caps on vertex count would make it safe and [measurement invalidated that](../benchmarks/geometry-overlay/RESULTS.md) — 6,408 adversarial vertices cost 153 s and 16.7 GB against 312 ms for a real 72,919-vertex outline. The linear-cost operations are unaffected |
