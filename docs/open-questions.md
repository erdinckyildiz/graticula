...
| Q-31 | Does the feature service expose provider capability differences to clients, or hide them behind a uniform contract that degrades silently? Hiding is friendlier and lies; exposing is honest and leaks. | Council | ADR-005, ADR-008, §28 |
